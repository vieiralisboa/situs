...
class Tv_Controller {
    ...
    public function get($request) {   
       //*/
        ...
        $path = $_SERVER["HTTP_HOST"] == "situs.dev" ? "\\\\MYBOOKLIVE\\Public\\Shared Videos\\new"
            : "/shares/Public/Shared Videos/new";
        #$path = "\\\\Mybookworld\\public\\Shared Videos\\new";
        ...
        if(count($request->uri) == 1)
        {
            ...
            foreach(scandir($path) as $video)
            {
                ...
                //$info['extension']
                //$info['filename']
                if(preg_match('/\.mp4$/', $video)) $videos[] = $info['filename'];//$video;
            }
